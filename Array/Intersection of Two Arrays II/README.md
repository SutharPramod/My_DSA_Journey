...
## Output
- Print space-separated integers representing the elements present in both arrays, including their correct frequencies.
...
**Explanation:** `[9, 4]` is also accepted. The frequency of 4 and 9 in both arrays is at least 1.